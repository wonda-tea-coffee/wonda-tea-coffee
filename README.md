# 自己紹介
こんにちは、@wonda-tea-coffee です。現職ではWebサービスのプロダクトセキュリティエンジニアをやっています。以前はフロントエンド、バックエンド、モバイルアプリと広く浅く開発をしていました。2021年初め頃からセキュリティに興味を持ちはじめ、現職に転職しました。
...
# 興味・関心
- セキュリティ
  - Webサービスに携わっているためWebセキュリティの勉強をしてきました
  - 今はWeb以外にも詳しくなりたいのでOSCPの勉強中です
- キャリア
  - セキュリティの領域でスペシャリストを目指しています
  - 当面はほどほどに働きながら学位を取るための勉強をする予定です（2023年4月～）
...
- [Offensive Security Certified Professional(OSCP)](#) -> I'll try harder
...
# 連絡先
Githubアカウントで公開しているメールアドレス宛にお願いします。
